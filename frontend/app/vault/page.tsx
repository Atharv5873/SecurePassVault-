...
export default function VaultPage() {
    ...
    useEffect(() => {
        ...
        const savedEmail = sessionStorage.getItem('user-email'); // This stores the email used for login
        if (!savedToken) {
            router.replace('/');
        } else {
            setToken(savedToken);
    ...
    return (
        <div className="bg-black text-white flex min-h-screen">
            {/* Sidebar */}
            <div className="w-80 bg-[#181c1b] border-r border-[color:var(--neon)]/20 flex flex-col min-h-screen sticky top-0">
                {/* Logo Section */}
                <div className="p-6 border-b border-[color:var(--neon)]/20">
                    <div className="flex items-center space-x-3">
                        <Image
                            src="/applogo.png.png"
                            alt="SecurePass Vault"
                            width={40}
                            height={40}
                            className="object-contain"
                        />
                        <div>
                            <h1 className="text-xl font-bold neon-text">SecurePass</h1>
                ...
                <nav className="flex-1 p-6">
                    <div className="space-y-2">
                        <button
                            ...
                            className={`w-full text-left px-4 py-3 rounded-lg transition-all duration-200 flex items-center space-x-3 ${activeTab === 'vault'
                                ? 'bg-[color:var(--neon)]/20 border border-[color:var(--neon)]/40 neon-text'
                        ...
                        <button
                            ...
                            className={`w-full text-left px-4 py-3 rounded-lg transition-all duration-200 flex items-center space-x-3 ${activeTab === 'add'
                                ? 'bg-[color:var(--neon)]/20 border border-[color:var(--neon)]/40 neon-text'
                                : 'text-gray-300 hover:bg-gray-800/50 hover:text-white'
                                }`}
                        >
                ...
                {/* User Section */}
                <div className="p-6 border-t border-[color:var(--neon)]/20">
            ...
            <div className="flex-1 flex flex-col min-h-screen bg-gradient-to-b from-[#181c1b] to-[#1a1f1a]">
                {/* Header */}
                <header className="bg-[#181c1b]/50 backdrop-blur-sm border-b border-[color:var(--neon)]/20 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                    ...
                    <div className="max-w-6xl mx-auto">
                        {activeTab === 'vault' ? (
                            ...
                            <div className="max-w-2xl mx-auto">
                                <div className="bg-[#181c1b] border border-[color:var(--neon)]/30 rounded-2xl p-8 shadow-xl">
