...
export const metadata: Metadata = {
    ...
    description:
        "Professional vulnerability assessment and penetration testing (VAPT) services for web apps. Secure your digital presence with Cyber Cordon.",
    keywords:
    ...
    openGraph: {
        title: "Cyber Cordon | Secure Your Web App",
        description:
            "Expert VAPT services for startups, businesses, and developers. Identify and fix vulnerabilities fast.",
        url: "https://cybercordon.vercel.app",
        siteName: "Cyber Cordon",
        images: [
            {
                url: "/og-image.png",
                width: 1200,
                height: 630,
                alt: "Cyber Cordon Banner",
            },
        ],
        type: "website",
    },
    twitter: {
        ...
        title: "Cyber Cordon | VAPT for Web Applications",
        description: "Protect your web app from security threats. Get professional penetration testing services.",
        images: ["/og-image.png"],
    },
};
...
export default function RootLayout({
    ...
    const orgSchema = {
        ...
        name: "Cyber Cordon",
        url: "https://cybercordon.vercel.app",
        logo: "https://cybercordon.vercel.app/logo.png",
    };
